...
export default class App extends React.Component<{}, IState> {
  ...
  public showDogStatic = () => {
    fetch("https://api.thedogapi.com/v1/images/search?mime_types=jpg", {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
              ...
              >
                {
                  <form>
                    ...
                    <label>
                      ...
                      <p>Select what type of image you want, then boop the Button to generate a new doggo! </p>
                    </label>
                    <br />
                    <RadioGroup
